...
count = 0
config_nameCalibrador = "letras.dat"
...
def main():
	...
	pui.initPuiConCapturaDeVideo(PuiModule.MODO_MULTI_MARKERS_CALIBRADOR,"",config_nameCalibrador,"../../bin/Data/camera_para.dat",vconf,usarAlgoritmoRapido,pui.NORMAL_SPEED_LOOP,1.0);
	...
	pui.capStart()
	pui.initPropiedadesCalibracionSoloApuntador(PuiModule.FORMA_APUNTADOR_CIRCULO,1,360,0,100,0,100,h_bins,s_bins,v_bins,0)
	print '3\n'	
	...
	if esperar:
		...
		print 'Guardo resultados en el archivo ../bin/Data/calibracionColorPy.con\n'
		pui.guardarSoloRangosColorApuntador("../../bin/Data/calibracionColorPy.con")
		...
		pui.guardarCalibracionApuntador("../../bin/Data/calibracionApuntadorCompletaPy.con",300,1.0,1,1,1,1);
